...
class ResConfigSettings(models.TransientModel):
    ...
    google_drive_api_key = fields.Char(string="Google Drive API key", config_parameter="google_drive.api_key")
    google_drive_condition = fields.Char(
        ...
        config_parameter="google_drive.condition",
    )
